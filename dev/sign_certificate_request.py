...
if __name__ == "__main__":
    ...
    ca_cert = load_root_certificate("/home/prominendt/repos/ZEUS-services-CA/dev/certs/root_ca.pem")
    private_ca_key = load_root_key("/home/prominendt/repos/ZEUS-services-CA/dev/certs/root_ca.key")

    cert = sign_certificate_request(csr_cert=csr_cert, ca_cert=ca_cert, private_ca_key=private_ca_key)
    print(cert.subject)
